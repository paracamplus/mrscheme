...
CanvasLib.installPrimEnv = function(penv) {
  ...
  /* nouveaux noms */
    ...
    penv.register("quart-de-tour", new CanvasLib.primitiveTurn());
};
...
CanvasLib.primitiveTurn = function () {
    ...
    this.exec = function (evaluator, lexenv, expr, args) {
        ...
        let image = new CanvasLib.TurnImage(args[0].image);
...
CanvasLib.TurnImage = function (image) {
    this.type = "image";
